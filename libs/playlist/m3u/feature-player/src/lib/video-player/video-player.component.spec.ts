...
class StubMatMenuTriggerForDirective {
    readonly matMenuTriggerFor = input<unknown>();
}
...
describe('VideoPlayerComponent', () => {
            ...
            .overrideComponent(VideoPlayerComponent, {
                set: {
                    imports: [
                        ...
                        StubMatMenuComponent,
                        StubMatMenuTriggerForDirective,
    ...
    it('renders and switches parsed alternate streams', () => {
        syncStoreState({
            ...sampleChannel,
            alternateStreams: [
                {
                ...
                {
                    label: 'Line 2',
                    url: 'http://localhost/backup.m3u8',
                },
            ],
        });
        player.set(VideoPlayer.VideoJs);
        ...
        expect(
            fixture.nativeElement.querySelector('.stream-switcher')
        ).not.toBeNull();

        component.switchActiveChannelStream('http://localhost/backup.m3u8');
